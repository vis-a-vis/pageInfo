...
var _pageInfo = __webpack_require__(34);
...
_reactDom2.default.render(_react2.default.createElement(_pageInfo2.default, null), document.getElementById('pageinfo'));
...
var _Summary = __webpack_require__(54);
...
var PageInfo = function (_React$Component) {
  ...
  function PageInfo(props) {
    ...
    var _this = _possibleConstructorReturn(this, (PageInfo.__proto__ || Object.getPrototypeOf(PageInfo)).call(this, props));
  ...
  _createClass(PageInfo, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Summary2.default, { category: this.state.cateogry, name: this.state.name, city: this.state.city, guest_num: this.state.guest_num, bedroom_num: this.state.bedroom_num, bath_num: this.state.bath_num })
      );
    }
  }]);
